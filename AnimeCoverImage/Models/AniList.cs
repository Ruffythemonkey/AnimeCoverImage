namespace AnimeCoverImage.Models
{
    internal class AniList
    {
        ...
        public class Variables
        {
            ...
            public string sort { get; set; } = "SEARCH_MATCH";
